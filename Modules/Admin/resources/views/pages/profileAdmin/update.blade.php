                        ...
                        <div class="card card-default">
                            ...
                            <form action="{{ route('admin.profileAdmin.store') }}" method="post" id="store">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-12">
                                        <div class="input-group">
                                            ...
                                            <input id="first_name" type="text" value="{{ $id->first_name }}"
                                                name="first_name" autocomplete="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group col-12">
                                        <div class="input-group">
                                            ...
                                            <input id="last_name" type="text" value="{{ $id->last_name }}"
                                                name="last_name" autocomplete="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group col-12">
                                        <div class="input-group">
                                ...
                                <div class="card-header text-center">
                                    ...
                                    <a href="http://127.0.0.1:8000/admin/staffs"
                                        class="btn btn-danger next-link__js">Hủy</a>
                                </div>
                            </form>
                        </div>
                    </div>
